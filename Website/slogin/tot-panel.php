      ...
      <div class="body-content" id="bodyID">
        <div class="msg">
          ...
          <div class="college-name">
              <h3>Tests and Exams</h3>
          </div>
          
         <ol type="square">
              <li><a href="./tests/toa.html" target="_blank">TOT Formative Assesment - 1<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
              <li><a href="./tests/toa2.html" target="_blank">TOT Formative Assesment - 2<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              <li><a href="./tests/toa3.html" target="_blank">TOT Formative Assesment - 3<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
            </ol>
          <hr>
        </div>
