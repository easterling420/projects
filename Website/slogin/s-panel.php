    ...
    <div class="main-body">
      ...
      <div class="body-content" id="bodyID">
        <div class="msg">
          ...
          <ol type="roman">
              <li><a href="./tests/basicele.html" target="_blank">Basic Electricity Test : 1<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
              
              <li><a href="./tests/basicele2.html" target="_blank">Basic Electronic Test : 1<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
              
              <li><a href="./tests/eleWorkshop.html" target="_blank">Workshop Calculation and Science Test<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
              
              <li><a href="./tests/electricity2.html" target="_blank">Electrician Theory Test - 2 (03 May 2020)<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
              <li><a href="./tests/electrical3.html" target="_blank">Electrician Theory Test-3 (10 May 2020)<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
               <li><a href="./tests/electrical4.html" target="_blank">Electrician Theory Test-4 (17 May 2020)<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
              <li><a href="./tests/workshop2.html" target="_blank">Workshop Cal & Sc Test-2(24 May 2020)<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              <li><a href="./tests/electrical5.html" target="_blank">Electrician Test-5(First Year, 07 Jun 2020)<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
               <li><a href="./tests/electrical2y1.html" target="_blank">Electrician Test-1(Second Year, 07 Jun 2020)<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
              <li><a href="./tests/electrical6.html" target="_blank">Electrician Test-6(15 Jun 2020)<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
          </ol>
          ...
          <ol type="roman">
              ...
              <li><a href="./tests/fitterWorkshop.html" target="_blank">Workshop Calculation and Science Test<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
              <li><a href="./tests/fitter2.html" target="_blank">Fitter Theory Test - 2 (03 May 2020)<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
               <li><a href="./tests/fitter3.html" target="_blank">Fitter Theory Test - 3 (10 May 2020)<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
               <li><a href="./tests/fitter4.html" target="_blank">Fitter Theory Test - 4 (17 May 2020)<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
               <li><a href="./tests/workshop2.html" target="_blank">Workshop Cal & Sc Test-2(24 May 2020)<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
               <li><a href="./tests/fitter5.html" target="_blank">Fitter Test-5(08 Jun 2020)<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
               <li><a href="./tests/fitter6.html" target="_blank">Fitter Test-6(15 Jun 2020)<i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a>
              </li>
          </ol>
